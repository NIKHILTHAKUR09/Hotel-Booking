    ...
    room && (
      <>
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
          ...
          {/* Room Address */}
          <div className="flex items-center gap-1 mt-2 teat-gray-500">
          ...
          <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500 flex-wrap">
              <div className="flex flex-col ">
                <label htmlFor="checkInDate" className="pl-1 font-medium">
                  Check-In
                </label>
                <input
                  type="date"
              ...
              <div className="flex flex-col ">
                <label htmlFor="checkOutDate" className="pl-1 font-medium">
                  Check-Out
                </label>
                <input
                  type="date"
              ...
              <div className="w-px h-15 bg-gray-300/70 max-md:hidden"></div>
              <div className="flex flex-col ">
                <label htmlFor="guests" className="pl-1 font-medium">
                  Guests
                </label>
                <input
                  type="number"
          ...
          <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-shadow-gray-500">
            <p>
              Guests be allocated on the ground floor according to availability.
              You get a comfortable Two bedroom apartment has a true city
              feeling. The price quoted is for two guest, at the guest slot
              pleas mark the number of guests to get the exact price for groups.
